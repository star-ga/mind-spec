...
```text
# MIND IR v1.2
# Generated by: mind-compiler v0.10.0
...
```console
$ mind --version
mind-compiler 0.10.0
Core v1.0 (CPU baseline)
Features: autodiff, mlir-lowering
```

(A GPU-profile implementation would additionally list the GPU profile and its backend
features; no implementation currently claims the GPU profile.)
...
- **Implementation version**: mind-compiler v0.10.x (current line)
- **Implements specification**: Core v1.0
