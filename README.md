...
- [Language specification](./spec/)
  ...
  - [IR stability + evidence chains](./spec/v1.0/ir-stability.md) — `mic@1` text + `mic@3` binary (RFC 0021), MAP epilogue (RFC 0014), and the load-bearing `trace_hash`-on-canonical-`mic@1` rule (RFC 0016 GAP-1).
