...
> **Last Updated:** 2026-05-18 · spec v1.0 · tracking compiler 0.4.2 (RFC 0005 shipped)
...
| 16. IR Stability | `spec/v1.0/ir-stability.md` | ✅ Stable | `mic@1` textual form as the runtime contract. Ratified by mindc 0.2.5 (Pratt + stable IR API); pure-MIND `__mind_*` intrinsic ABI ratified by mindc 0.4.2 (RFC 0005). |
...
| -------------- | ---- | ------ | ----- |
| MIND Compiler | [`star-ga/mind`](https://github.com/star-ga/mind) | ✅ Complete | v0.4.2 (RFC 0005 shipped — pure-MIND `std.vec`/`string`/`map`/`io` bundled, Phase A/B/C resolver). Frontend floor 2.80–17.10 µs (post-RFC-0005 baseline, +5% gate). |
